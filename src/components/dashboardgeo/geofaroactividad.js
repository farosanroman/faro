...
export default function GeoFaroActividad() {
      ...
      <CardActionArea>
        ...
        <Paper style={style2.Paper}>
          ...
          <Table><TableRow><TableCell align='center' vertical-align='top'>
                   <Circle animate={true} animationDuration="1s"   progress={56} size={60} percentSpacing={10}  bgColor="lightgray"  
                    textColor="black" progressColor="purple"    roundedStroke={false}  showPercentage={true}  showPercentageSymbol={true} lineWidth={50}/>
                  </TableCell>
              </TableRow>
            </Table>  
                     ...
                     <table width="100%">
                      <tbody>
                        <tr><td>
                          ...
                          <Typography  variant="subtitle2">12.345 (30%)</Typography>
                        </td></tr>
                  ...
                  <Paper>
                     <table width="100%">
                      <tbody>
                        <tr><td>
                          <Typography  variant="subtitle2">Correos:</Typography>
                        </td><td align="right">
                          <Typography  variant="subtitle2">23 (50%)</Typography>
                        </td></tr>
                  ...
                  <Paper>
                     <table width="100%">
                      <tbody>
                        <tr><td>
                          <Typography  variant="subtitle2">Encuestas:</Typography>
                        </td><td align="right">
                          <Typography  variant="subtitle2">103 (30%)</Typography>
                        </td></tr>
                     ...
                     <table width="100%">
                      <tbody>
                        <tr><td>
                          ...
                          <Typography  variant="subtitle2">20.021 (33%)</Typography>
                        </td></tr>
